...
export default function AutomationSection() {
  ...
  return (
    <section className="py-8 px-4 lg:py-16 lg:px-6 relative mt-8 bg-purple-100">
      {/* Title */}
      <div className="text-center mb-12">
        <h2 
          className="text-3xl sm:text-4xl lg:text-4xl font-extrabold tracking-tight"
          data-aos="fade-up"
        >
      ...
      <div className="flex flex-col lg:flex-row items-center">
        {/* Image on the Left */}
        <div 
          className="flex-1 lg:pr-8 mb-8 lg:mb-0 flex justify-center"
          data-aos="fade-in"
        >
          <img 
        ...
        <div className="flex-1 flex flex-col justify-center items-start text-left">
          <div className="space-y-4 mb-8">
            <div 
              className="text-lg sm:text-xl md:text-2xl flex items-center text-black"
              data-aos="fade-right" 
              data-aos-delay="200"
            >
          ...
          <button 
            className="w-full mt-4 sm:mt-0 sm:ml-4 sm:w-40 px-4 py-3 rounded font-semibold text-md bg-white text-indigo-600 border-2 border-indigo-600"
            data-aos="zoom-in" 
            data-aos-delay="800"
          >
            Watch a Demo
