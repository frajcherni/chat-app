    ...
    Elevate customer interactions with our advanced live chat solutions.
        ...
        <div className="grid gap-8 md:gap-12 lg:gap-16 md:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <div className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
              <p className="mb-4">
        ...
        <div className="text-center mt-12">
          <p className="font-light text-base sm:text-lg md:text-xl lg:text-2xl text-gray-900 dark:text-white" style={{ fontFamily: 'Roboto, sans-serif' }}>
