            ...
            <section className="relative mt-24">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-6 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        ...
                        Unleash The Power Of Chat <br></br>Marketing</h2>
                        <p className="max-w-2xl mx-auto text-gray-400">
                        Drive more sales and conversions on Instagram, WhatsApp, and Messenger using automation.                        </p>
...
>
    ...
    />
    <button
        className="w-full sm:w-40 px-4 py-2 mt-3 sm:mt-0 rounded font-semibold text-md bg-indigo-600 text-white border-2 border-indigo-600"
    >
        Get started
    </button>
</form>
                        ...
                        <div className="flex justify-center">
                            <img 
                                className="w-full max-w-2xl rounded-lg  mt-16" 
                                src="/images/hero.png"
