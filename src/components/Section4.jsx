...
const Section4 = () => {
  return (
    <div className="flex flex-col md:flex-row pt-12 px-6 md:px-20 items-center justify-center md:h-screen overflow-hidden">
      <div className="flex flex-col-reverse md:flex-row items-center max-w-8xl">
        ...
        <div className="w-full md:w-1/2 lg:pl-16">
          <h2 className="mb-4 text-3xl sm:text-4xl lg:text-4xl tracking-tight font-extrabold  md:text-left">
